...
namespace Puppeteer.EventSourcing.Interprete.Libraries
{
	...
	class OpAnd : Expresion
	{
		...
		internal override void validarEstaticamente()
		{
			...
			{
				throw new LanguageException(string.Format("La expresi�n {0} al lado derecho del AND debe retornar un valor true o false.", e2.GetType().Name));
			}
		}
